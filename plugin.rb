...
Rails.application.config.action_dispatch.default_headers.merge!({'Content-Security-Policy' => 'default-src \'self\' zodiacpd.org *.zodiacpd.org zodiacpd.herokuapp.com; frame-src zodiacpd.org *.zodiacpd.org zodiacpd.herokuapp.com'})
